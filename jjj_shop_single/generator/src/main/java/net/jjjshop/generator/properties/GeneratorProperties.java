...
package net.jjjshop.generator.properties;

import com.baomidou.mybatisplus.generator.config.DataSourceConfig;
import net.jjjshop.generator.config.GeneratorConfig;
import net.jjjshop.generator.config.MybatisPlusGeneratorConfig;
import net.jjjshop.generator.config.ProjectConfig;
import net.jjjshop.generator.config.TableConfig;
import lombok.Data;
