	...
	export default {
		...
		methods: {
			...
			registerSub() {
				...
				self.register.invitationId = uni.getStorageSync('invitationId') ? uni.getStorageSync('invitationId') :
					0;
				...
				self._postBody('user/userOpen/register',
					self.register,
					result => {
						uni.showToast({
							title: '注册成功',
				    ...
				    success: function (loginRes) {  
				        ...
				        uni.getUserInfo({  
				            ...
				            success(res) {  
								...
								self._postBody('user/userapple/login', {
