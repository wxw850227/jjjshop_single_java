<template>
  <div v-loading="loading" class="diy-container clearfix">
    <!--类别选择-->
    <div class="diy-menu"><Type v-if="!loading" :defaultData="defaultData" :diyData="diyData"></Type></div>

    <!--手机diy容器-->
    <div class="diy-phone"><Model v-if="!loading" ref="model" :form="form" :diyData="diyData"></Model></div>

    <!--参数设置-->
    <div class="diy-info"><Params v-if="!loading" :form="form" :diyData="diyData"></Params></div>
    ...
    getData() {
      ...
      PageApi.toAddPage({}, true)
        .then(res => {
          ...
          self.diyData = res.data.jsonData.page;
