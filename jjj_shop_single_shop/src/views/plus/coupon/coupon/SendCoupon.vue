    ...
    <div class="product-content">
      <el-form ref="form" size="small" :model="form" label-width="150px">
        ...
        <el-form-item label="选择优惠券 " prop="name" :rules="[{ required: true, message: ' ' }]">
          <el-input type="text" v-model="form.name" placeholder="请选择优惠券" class="max-w460 mr10" :disabled="true"></el-input>
  ...
  methods: {
    ...
    closeCouponFunc(e) {
      ...
      if (e && e.type != 'error') {
        ...
        this.form.coupon_id = e.params.couponId;
      }
    },
    ...
    onSubmit() {
      let self = this;
      let params = {};
      params.sendType = self.form.send_type;
      params.couponId = self.form.coupon_id;
      params.userLevel = self.form.user_level;
